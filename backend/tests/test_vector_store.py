...
class TestVectorStoreSearch:
    ...
    def test_search_with_max_results_zero(self, mock_embedding_func, mock_chroma_client):
        ...
        assert result.is_empty(), "Search with MAX_RESULTS=0 should return empty results"
        assert len(result.documents) == 0, "Documents should be empty when MAX_RESULTS=0"
    
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_search_with_proper_max_results(self, mock_embedding_func, mock_chroma_client):
        ...
        assert not result.is_empty(), "Search with proper MAX_RESULTS should return results"
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_search_with_course_name_filter(self, mock_embedding_func, mock_chroma_client):
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_search_with_combined_filters(self, mock_embedding_func, mock_chroma_client):
        ...
        result = vector_store.search("deep learning", course_name="Advanced", lesson_number=3)
...
class TestVectorStoreCourseResolution:
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_resolve_course_name_not_found(self, mock_embedding_func, mock_chroma_client):
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_resolve_course_name_exception(self, mock_embedding_func, mock_chroma_client):
