...
class TestConfigValidation:
    ...
    def test_max_results_configuration(self):
        ...
        assert config.MAX_RESULTS > 0, f"MAX_RESULTS is {config.MAX_RESULTS}, should be > 0 for search to work"
    ...
    def test_chunk_overlap_configuration(self):
        ...
        assert config.CHUNK_OVERLAP <= config.CHUNK_SIZE * 0.5, "CHUNK_OVERLAP should not exceed 50% of CHUNK_SIZE"
...
class TestConfigImpactOnSearch:
    ...
    def test_max_results_zero_impact(self, mock_vector_store_class):
        ...
        if config.MAX_RESULTS == 0:
            ...
            assert len(result['documents'][0]) == 0, "MAX_RESULTS=0 causes empty search results"
    ...
    def test_config_edge_cases(self):
        ...
        test_cases = [
            ...
            {"MAX_RESULTS": -1, "should_work": False, "reason": "Negative results count invalid"},
        ...
        for case in test_cases:
            ...
            if should_work:
                ...
                if max_results <= 0:
                    assert max_results <= 0, f"MAX_RESULTS={max_results} {reason} - This is a known issue"
...
class TestConfigEnvironmentVariables:
    ...
    def test_env_variable_loading(self):
        ...
        assert hasattr(config, 'ANTHROPIC_API_KEY'), "Config should have ANTHROPIC_API_KEY attribute"
    ...
    def test_env_override(self):
        ...
        new_config = Config()
        assert new_config.ANTHROPIC_API_KEY == 'test_key_123', "Environment variable should override default"
    
    @patch.dict(os.environ, {'ANTHROPIC_API_KEY': ''})
    def test_empty_env_variable(self):
        """Test handling of empty environment variables"""
        new_config = Config()
        assert new_config.ANTHROPIC_API_KEY == "", "Empty environment variable should be preserved"