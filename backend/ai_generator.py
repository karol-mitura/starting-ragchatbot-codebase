...
"""
    ...
    def _make_api_call(self, messages: List[Dict], system_content: str, tools: Optional[List]) -> Any:
    ...
    def _execute_tools_for_round(self, messages: List[Dict], response, 
                                tool_manager, current_round: int) -> List[Dict]:
        """
    ...
    def _generate_simple_response(self, query: str, conversation_history: Optional[str]) -> str:
